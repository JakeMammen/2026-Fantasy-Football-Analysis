...
roster <- nflreadr::load_rosters(2026) %>%
...
ff_opportunity <- load_ff_opportunity(seasons = 2026, stat_type = "weekly", model_version = "latest")
...
gtsave(fp_WR2026, 
       filename = "output/tables/exp_fp_WR2026.png")
...
gtsave(fp_RB2026,
       filename = "output/tables/exp_fp_RB2026.png")
